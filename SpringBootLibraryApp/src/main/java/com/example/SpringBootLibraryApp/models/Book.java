package com.example.SpringBootLibraryApp.models;
...
public class Book {
    ...
    @Min(value = 1500, message = "Year must be between 1901 and 2025")
    @Max(value = 2024, message = "Year must be between 1901 and 2025")
    @Column(name = "year")
    private int year;
    ...
    @Transient
    private boolean expired; // Hibernate will ignore this field. Default is false.
